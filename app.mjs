...
function widths(){return {left:$('widthLeft').value===''?NaN:Number($('widthLeft').value),right:$('widthRight').value===''?NaN:Number($('widthRight').value)};}
...
for(const id of ['widthLeft','widthRight'])$(id).oninput=()=>{if(profile)recalc();};
